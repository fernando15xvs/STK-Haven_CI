...
Future<void> showRecoveryHistoryDialogWeb(
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                const Text('Historial de recuperación'),
                Text(
                  'Últimos ${history.completedDays} check-ins',
            ...
            : SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    _ScoreChart(history: history, maxPoints: 14),
                    const SizedBox(height: AppSpacing.md),
        ...
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Compara el volumen completado con la sesión anterior de la misma rutina.',
                      style: AppTypography.bodySmall.copyWith(
                        color: AppColors.textSecondary,
                      ),
                    ),
          ...
          if (!insight.hasEnoughData) ...[
            ...
            Wrap(
              spacing: AppSpacing.sm,
              runSpacing: AppSpacing.xs,
              children: insight.points.take(5).map((point) {
                return Container(
                  width: 250,
          ...
          SizedBox(
            ...
            child: Row(
              ...
              children: points.map((entry) {
                ...
                final barHeight = 30 + (entry.score * 1.08);
                return Expanded(
                  child: Tooltip(
                    message:
